...
public class Coro extends AgrupacionOficial {
	...
	/**
	 * Constructor con 8 parametros Crea objetos heredados del constructor de tipo
	 * AgrupacionOfical con con nombre, autor , autorMusica, autorLetra, tipo
	 * disfraz, puntos obtenidos y crea objetos tipo Coro con numBandurrias y
	 * numGuitarras
	 * 
	...
	public Coro(String nombre, String autor, String autorMusica, String autorLetra, String tipoDisfraz,
			Integer puntosObt, Integer numBandurrias, Integer numGuitarras) {
	...
	public String toString() {
		return "Coro " + super.toString() + ", Número bandurrias=" + numBandurrias + ", Número guitarras="
				+ numGuitarras;
	}
